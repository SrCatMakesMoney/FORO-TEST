...
router.get("/search", auth, async (req, res) => {
  try {
    ...
    const usuarios = await User.find({
      ...
      .select(
        "nombre handle avatar avatarTipo seguidores"
      )
      .limit(10)
      .lean();
  ...
  try {
    ...
    const usuarios =
      await User.find({
        ...
        .select(
          "nombre handle avatar avatarTipo personalizacion seguidores"
        )
        .limit(5)
        .lean();
  ...
  try {
    ...
    // ========================================================
      ...
      await crearNotificacion({
        ...
        url:
          `/profile.html?handle=${req.usuario.handle}`
